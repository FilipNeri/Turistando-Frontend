  ...
  methods: {
    ...
    posicaoAtual() {
      navigator.geolocation.getCurrentPosition((position) => {
        ...
        console.log(position.coords.latitude, "a");
        console.log(position.coords.longitude, "a");
      });
      this.limparPontos();
      this.pontos();
    ...
    async listar() {
      if (this.$route.query.id != undefined) {
        await this.fetchApi().then((response) => {});
      } else {
      ...
      this.historia = this.obj.obj.historia;
      this.destino = this.obj.obj.coordinates;
    },

    abrirMapa() {
      setTimeout(this.abre, 2000);
    },
    abre() {
      this.abrir = true;
    },
