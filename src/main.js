...
import RoteiroTuristico from './components/RoteiroTuristico.vue'
import Eventos from './components/Eventos.vue'
import PontosHistoricos from './components/PontosHistoricos.vue'
import Praias from './components/Praias.vue'
...
const routes = [
  ...
  { path: '/roteiroturistico', component: RoteiroTuristico },
  { path: '/estabelecimentos', component: Estabelecimentos },
  { path: '/pontoshistoricos', component: PontosHistoricos },
  { path: '/praias', component: Praias }
]
